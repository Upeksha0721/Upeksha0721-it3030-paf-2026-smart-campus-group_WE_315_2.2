...
function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      console.log('✅ Decoded JWT:', decoded); // 🔍 Check role here in browser console

      localStorage.setItem('token',    token);
      localStorage.setItem('role',     decoded.role);     // e.g. STAFF, STUDENT, ADMIN
      localStorage.setItem('userName', decoded.sub);      // email

      navigate('/dashboard'); // DashboardRouter in App.js handles role routing
    } catch {
